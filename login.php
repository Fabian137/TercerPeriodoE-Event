...
if(!empty($_POST)){
  $registro = register::where('correo', $_POST['correo']) -> first();
    if($registro){
      if(\password_verify($_POST['password'], $registro-> password)){
        echo 'Contraseña correcta';
        header("Location: assets/calculadora.php");
        die();
      }
      else{
    ...
    <nav class="colorfont">
      ...
      <section class="formulario">
        <div class="row">
          ...
          <form id="forms" class="col s12 m8 l8" action="login.php" method="post">
            <!-- <div class="row">
